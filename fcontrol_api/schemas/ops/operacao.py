...
class OperacaoKpis(BaseModel):
    ...
    comb_transf: int  # combustível transferido em REVO (L)
    heavy_qtd: int  # cargas heavy lançadas
    cds_qtd: int  # cargas CDS lançadas
    peso_lancado: int  # peso total de cargas lançadas (kg)
