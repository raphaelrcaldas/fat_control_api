...
class TestCalcularDvSaram:
    ...
    def test_calcula_dv_com_resultado_10_vira_0(self):
        ...
        # DV = 11 - 1 = 10 -> 0
        # Testando 545454:
        # 4*2 + 5*3 + 4*4 + 5*5 + 4*6 + 5*7 = 8+15+16+25+24+35 = 123
        # 123 % 11 = 2, DV = 11 - 2 = 9
        ...
        # Testando 272727:
        # 7*2 + 2*3 + 7*4 + 2*5 + 7*6 + 2*7 = 14+6+28+10+42+14 = 114
        # 114 % 11 = 4, DV = 11 - 4 = 7
        # Testando 181818:
        # 8*2 + 1*3 + 8*4 + 1*5 + 8*6 + 1*7 = 16+3+32+5+48+7 = 111
    ...
    def test_calcula_dv_com_resultado_11_vira_0(self):
        ...
        # Testando 363636:
        # 6*2 + 3*3 + 6*4 + 3*5 + 6*6 + 3*7 = 12+9+24+15+36+21 = 117
        # 117 % 11 = 7, DV = 11 - 7 = 4
        # Testando 454545:
        # 5*2 + 4*3 + 5*4 + 4*5 + 5*6 + 4*7 = 10+12+20+20+30+28 = 120
        # 120 % 11 = 10, DV = 11 - 10 = 1
        # Testando 545454: soma = 123 (já calculado), 123 % 11 = 2
        # Testando 636363:
        # 3*2 + 6*3 + 3*4 + 6*5 + 3*6 + 6*7 = 6+18+12+30+18+42 = 126
        # 126 % 11 = 5, DV = 11 - 5 = 6
        # Testando 727272:
        # 2*2 + 7*3 + 2*4 + 7*5 + 2*6 + 7*7 = 4+21+8+35+12+49 = 129
        # 129 % 11 = 8, DV = 11 - 8 = 3
        # Testando 818181:
        # 1*2 + 8*3 + 1*4 + 8*5 + 1*6 + 8*7 = 2+24+4+40+6+56 = 132
